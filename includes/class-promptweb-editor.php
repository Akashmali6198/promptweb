	...
	public function get_client_config() {
		...
		$config = array(
			...
			'i18n'        => array(
				...
				'liveOnlyNote'      => __( 'Live preview updates as you type. Click Publish to save your design and update GitHub in one step.', 'promptweb' ),
				'publishChanges'    => __( 'Publish', 'promptweb' ),
				'publishing'        => __( 'Publishing…', 'promptweb' ),
				'published'         => __( 'Published', 'promptweb' ),
				'publishHint'       => __( 'Publishes your edits to the live blueprint on GitHub. Design data is never deleted.', 'promptweb' ),
				'publishSuccessDetail' => __( 'Your changes are live on GitHub.', 'promptweb' ),
				'publishError'      => __( 'Publish failed. Your local edits are still on this page.', 'promptweb' ),
				'saveChanges'       => __( 'Save Changes', 'promptweb' ),
				'saving'            => __( 'Saving…', 'promptweb' ),
				'saveSuccess'       => __( 'Blueprint updated in memory.', 'promptweb' ),
				'saveNoDirty'       => __( 'No local changes to merge (using current blueprint).', 'promptweb' ),
				'saveNoBlueprint'   => __( 'No blueprint loaded. Connect GitHub and wait for auto-sync, or use Sync backup.', 'promptweb' ),
				...
				'pushNoBlueprint'   => __( 'Nothing to publish yet. Make an edit or wait for a blueprint to load.', 'promptweb' ),
				'pushHint'          => __( 'Publish saves and updates GitHub in one click.', 'promptweb' ),
				'aiTarget'          => __( 'Target', 'promptweb' ),
				'aiScopePage'       => __( 'Entire page / blueprint', 'promptweb' ),
				'aiScopePageBadge'  => __( 'page', 'promptweb' ),
				'aiContextNote'     => __( 'Write plain English only. Publish stores your prompt as pending for an external AI (Grok/Claude/ChatGPT) — WordPress never calls AI APIs.', 'promptweb' ),
				'aiPromptLabel'     => __( 'What should change?', 'promptweb' ),
				'aiPromptPlaceholder' => __( 'e.g. Make the hero modern with a soft gradient and a clear call-to-action…', 'promptweb' ),
				'aiSavePrompt'      => __( 'Save Prompt (local only)', 'promptweb' ),
				'aiPublishPrompt'   => __( 'Publish Prompt', 'promptweb' ),
				'aiSaveAndPush'     => __( 'Publish Prompt', 'promptweb' ),
				'aiPromptEmpty'     => __( 'Please enter a prompt before publishing.', 'promptweb' ),
				...
				'aiPushSuccess'     => __( 'Prompt published to GitHub for external AI.', 'promptweb' ),
